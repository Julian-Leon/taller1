...
public class CalculadoraEstadisticas
{
	...
	public String<>PaisRepresenta(String nombreAtleta)
	//public Map<String, Object> PaisRepresenta(String nombreAtleta)
	//{
		//Map<String, Object> resultado = null;
		//Atleta elAtleta = buscarAtleta(nombreAtleta);
		//if (elAtleta != null)
		//{
			//resultado = new Map<String, Object>();
			
		//}
	//}
	
	//public ArrayList<Map<String, Object>>PaisRepresenta (String nombreAtleta)
	//{
		//ArrayList<Map<String, Object>> response = new ArrayList<Map<String, Object>>();
			//respuesta =  buscarAtleta(nombreAtleta);
	//}
	/**
	...
	//private Atleta PaisRepresenta(String nombreAtleta)
	//{
		//resultado = elAtleta.get(nombreAtleta);
