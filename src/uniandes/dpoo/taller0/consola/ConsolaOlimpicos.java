...
public class ConsolaOlimpicos
{
	...
	public void mostrarMenu()
	{
		...
		System.out.println("13. Consultar a cual país representa el atleta");
	...
	//ACÁ INSERTO LA EJECUCION DE MI NUEVA FUNCION AL MENÚ. BUSCO EL PAIS DEL ATLETA.
	private void ejecutarPaisRepresenta()
	{
		System.out.println("\n" + "El ateleta representa a: " + "\n");

		String nombre = input("Por favor ingrese el nombre de un atleta");
		Map respuesta = calculadora.PaisRepresenta(nombre);
	}
